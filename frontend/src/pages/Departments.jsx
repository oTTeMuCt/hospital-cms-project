...
export default function Departments() {
  ...
  const [form, setForm] = useState({ name: "", hospital: "", department_type: "", description: "" });
  ...
  const openCreate = () => {
    setEditing(null);
    setForm({ name: "", hospital: hospitals[0]?.id || "", department_type: "", description: "" });
    setShowModal(true);
  };
    ...
    <div>
      <div className="page-header">
        <div className="flex-between">
          <div>
            <h1>🏛️ Отделения</h1>
            <p>Управление отделениями больниц</p>
          </div>
      ...
      <div className="page-content">
        ...
        {departments.length === 0 ? (
          <div className="empty-state">
            ...
            <h3>Нет отделений</h3>
            <p>Создайте первое отделение</p>
            <button className="btn btn-primary" onClick={openCreate}>➕ Добавить отделение</button>
          </div>
        ) : (
          ...
          <div className="modal-overlay" onClick={() => setShowModal(false)}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              <div className="modal-header">
                <h2>{editing ? "Редактировать" : "Добавить"} отделение</h2>
              ...
              <form onSubmit={handleSave}>
                <div className="modal-body">
                  <div className="form-group">
                    ...
                    <select className="input" value={form.hospital} onChange={(e) => setForm({ ...form, hospital: e.target.value })} required>
                  ...
                  <div className="form-group">
                    <label>Тип отделения</label>
                    <select className="input" value={form.department_type} onChange={(e) => setForm({ ...form, department_type: e.target.value })}>
                      ...
                      <option value="reception">Приёмное отделение</option>
